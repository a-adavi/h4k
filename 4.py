...
def menu():
    ...
    print(colored("instagram: A_ir5", 'blue'))
    print(colored("code by : Alireza adavi ", 'red'))
    print("___________________________")
    ...
    print(colored("[15] test strong your pass ", 'green'))
    print(colored("[16] passlist generate ", 'green'))
    print(colored("[17] get info number", 'green'))
    print("[18] Choos a password For social mdia")
    print(colored("[19] NetworkScan", 'green'))
    print(colored("[20] get wifi password", 'green'))
    print(colored("[21] Get webpage contents",'green'))
    print(colored("[22] Extract all the URLs from the webpage",'green'))
    print(colored("[23] DOS attack DATEBASE",'green'))
    print(colored("[24] find all website url",'green'))
